    ...
    <div className="flex flex-col h-screen justify-center place-items-center bg-slate-900/60">
      <div className="w-full max-w-lg max-h-lg">
        ...
        <div className="flex flex-col justify-center place-items-center">
          ...
          <h5 className="pb-4 text-center">Cute, disposable links that <strong>expire after five hours.</strong> Death comes for us all.</h5>
          <h5 className="pb-4 text-center">Please report any shortlinks that link to abusive content to <a className="text-sky-400 hover:underline" href="https://twitter.com/distantsynths">@distantsynths</a> on Twitter.</h5>
        </div>
