        ...
        <div className="w-full max-w-lg max-h-lg">
          <form className="md:bg-slate-700/20 md:ring-1 md:ring-inset md:ring-white/10 md:shadow-2xl md:rounded-2xl px-8 pt-6 pb-8 mb-4">
            <div className="flex flex-col justify-center place-items-center">
              <h1 className="text-4xl font-semibold text-slate-200/95 py-6">
                Cutelinks
              </h1>
              <h5 className="pb-4 text-center">
                Cute, disposable links that{" "}
                <strong>expire after four hours.</strong> Death comes for us
                all.{" "}
                <a
                  className="text-sky-400 hover:underline"
                  href="https://github.com/flynnjh/cutelinks"
                >
              ...
              <h5 className="pb-4 text-center">
                Please report any abusive shortlinks to{" "}
                <a
                  className="text-sky-400 hover:underline"
                  href="https://twitter.com/distantsynths"
                >
                  @distantsynths
                </a>{" "}
                on Twitter.
              ...
              <h5 className="pb-4 text-center">
                Any shortlink that&apos;s found to have an offensive slug or
                illegal content will be deleted without warning.
              </h5>
            </div>
            <div className="flex flex-row text-lg justify-center font-bold text-sky-400/95 pb-4 gap-6 w-auto">
              ...
              <Link href="/delete">
                <a className="hover:underline">Delete</a>
              </Link>
            </div>
