      ...
      <div className="flex flex-col h-screen justify-center place-items-center md:bg-slate-900/60 bg-[#1E2536]">
        <div className="w-full max-w-lg max-h-lg">
          <form className="md:bg-slate-700/20 md:ring-1 md:ring-inset md:ring-white/10 md:shadow-2xl md:rounded-2xl px-8 pt-6 pb-8 mb-4">
            <h1 className="flex justify-center text-4xl font-semibold text-slate-200/95 py-4 break-all">
              Delete your Cutelink
            </h1>
            <h1 className="flex justify-center text-2xl font-semibold text-slate-200/95 pb-4 break-all">
              :(
            </h1>
            ...
            {info ? (
              <div className="flex flex-col justify-center place-items-center pt-6 font-semibold">
                <h1 className="text-sky-400 hover:underline">{info}</h1>
              </div>
            ) : null}

            {errorMessage ? (
              <h1 className="flex flex-col justify-center place-items-center pt-6 font-semibold text-red-400">
                {errorMessage}
              </h1>
            ) : null}
          </form>
